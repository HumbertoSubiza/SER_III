...
vendas <- read.csv("c:/Users/humberto.pina/Documents/SER_III/ST/data/IBGE_VVCVA.csv", 
                   header=FALSE, 
                   dec=".",
                   stringsAsFactors = F)
...
```{r} 
write.csv(data.frame(previsao), "data/sarima_previsao.csv")
write.xlsx(data.frame(previsao), "data/previsao.xlsx")
```
