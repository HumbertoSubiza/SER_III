...
O propósito do trabalho é apresentar o análise de uma série temporal de dados com duas metodologias diferentes, SSA e Rede Neural, assim como fazer uma previsão de comportamento da variável a futuro.

 A serie temporal  a ser analisada tem dados sobre o volume de vendas do comercio varejista ampliado (VVCVA) entre Janeiro de 2003 e Dezembro de 2011. A serie inclue além do comercio varejista, os setores de "Veículos, motocicletas, partes e peças" e "Material de construção". A categoria selecionada foi de Indice de base fixa com 2003 = 100.
