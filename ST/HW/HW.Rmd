...
knitr::opts_chunk$set(echo      = FALSE,
                      ...
                      message   = FALSE,
                      fig.align = "center",
                      fig.path  ='D:/Users/humberto.pina/Documents/R/SER_III/ST/figuras/', #                      fig.path  ='~/SER_III/ST/figuras/',
                      fig.ext   = 'png')
```
...
vendas <- read.csv("~/R/SER_III/ST/data/IBGE_VVCVA.csv", 
                   header=FALSE, 
                   dec=".",
                   stringsAsFactors = F)
...
vol_2012 <- read.csv2("~/R/SER_III/ST/data/2012.csv",
                 header=FALSE, 
                 stringsAsFactors = F)
```
...
HW_prev <- write.csv2(p, "D:/Users/humberto.pina/Documents/R/SER_III/ST/data/HW_previsao_2012.csv")
```
